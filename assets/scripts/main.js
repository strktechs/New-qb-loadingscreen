...
$(".keyoverlay .kbind").html(Config.CustomBindText == "" ? String.toUpperCase() : Config.CustomBindText1)
...
function setup() {
    ...
    //key
    Config.keylayer.forEach((keykey, index) => {
        $(".key_player .keylayer").append(`<div class="box" data-id="${keykey.name}"><img class="icon" src="${keykey.icon}"><div class="info"><p class="title">${keykey.label}</p><p class="description">${keykey.description}</p></div></div>`)
    });
...
tag.src = "https://youtu.be/Fpvf4apzorw";
